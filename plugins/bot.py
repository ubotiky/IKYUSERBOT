...
async def _(event):
    start = time.time()
    x = await event.eor("Baaa, "__Sedang Memuat.__")
    await ping.edit("__Tunggu..__")
    await ping.edit("__Bentar lagi...__")
    await ping.edit("__Sabar kontol.__")
    await ping.edit("__Tunggu ya..__")
    await ping.edit("__5jam lagi...__")
    await ping.edit("__Cie nungguin.__")
    await ping.edit("__Awokawokawok..__")
    await ping.edit("__Udah KONTOL...__")
